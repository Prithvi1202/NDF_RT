...
namespace NDFHIERARCHY
{
    public partial class Form12 : Form
    {
        ...
        public Form12(long value1, long value2, long value3, long value4, long value5, long value6)
        {
            val1 = value1;
            val2 = value2;
            val3 = value3;
        ...
        private void Form12_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataAdapter dar = new SqlDataAdapter("SELECT [TYPE_GID number ],[NAME string ] FROM [NDFHIERARCHY].[dbo].[DTS_ROLE_TYPE_ARCHIVE] WHERE [TYPE_GID number ] IN (" + val1 + ", " + val2 + " , " + val3 + ", " + val4 + " , " + val5 + ","+ val6 +")", cnn);
