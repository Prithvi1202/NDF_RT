...
namespace NDFHIERARCHY
{
    public partial class Form8 : Form
    {
        ...
        long val1, val2;
        string myValue;
       public Form8(long value1, long value2)
        {
            val1 = value1;
            val2 = value2;
        ...
        private void Form8_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataAdapter dar = new SqlDataAdapter("SELECT [TYPE_GID number ],[NAME string ] FROM [NDFHIERARCHY].[dbo].[DTS_ROLE_TYPE_ARCHIVE] WHERE [TYPE_GID number ] IN (" + val1 + ", "+ val2 +")", cnn);
