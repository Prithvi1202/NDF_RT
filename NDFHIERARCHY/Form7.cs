...
namespace NDFHIERARCHY
{
    public partial class Form7 : Form
    {
        ...
        long val1, val2, val3;
        String myValue;
        public Form7(long value1, long value2, long value3)
        {
            val1 = value1;
            val2 = value2;
            val3 = value3;
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlDataAdapter dar = new SqlDataAdapter("SELECT [TYPE_GID number ],[NAME string ] FROM [NDFHIERARCHY].[dbo].[DTS_ROLE_TYPE_ARCHIVE] WHERE [TYPE_GID number ] IN (" + val1 + "," + val2 + " , " + val3 + ")", cnn);
